...
from .utils.enums import Enum_Applications as Enum_Applications
from .utils.enums import Enum_Filters as Enum_Filters
from .utils.enums import Enum_Source as Enum_Source
from .utils.enums import Type_Loop as Type_Loop
from .utils.enums import (
    actual_class_name_for_class_methods as actual_class_name_for_class_methods,
)
from .utils.enums import needed_args as needed_args
...
class Music(commands.Cog):
    ...
    async def play(
        self, ctx: commands.Context, source: Enum_Source = ..., *, query: str = ...
    ): ...
    ...
    async def apply_single_filter(
        self, ctx: commands.Context, filters: Enum_Filters
    ): ...
